...
RunningMode="Closure,SystRun" #"Closure,SystRun" #"IDValidation" #"Closure" #"IDValidation" #"FRMeasure,SiglWP" #"IDValidation" #"FRMeasure,SiglWP" #"NormCheck,SystRun" #"NormCheck" #"CheckIDVarDist" #"IPEffScan"
