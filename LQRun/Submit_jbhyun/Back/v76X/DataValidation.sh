...
## RUN PARAMETERS
AnalysisCode="Jul2016_3l4j_DataValid" ###_D3lv" ###"Jun2016_3l4j_SigBasic" ###KPS ###"ExampleAnalyzerDiMuon"
Stream="SingleElectron" ###"SingleElectron" ### DoubleMuon DoubleEG MuonEG SingleElectron SingleMuon 
