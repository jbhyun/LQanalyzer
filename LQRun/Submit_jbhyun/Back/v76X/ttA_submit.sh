...
## RUN PARAMETERS
AnalysisCode="Oct2016_ttA_DataMCComp"  ##"Sep2016_3l4j_DataMCComp" ###_D3lv" ###"Jun2016_3l4j_SigBasic" ###KPS ###"ExampleAnalyzerDiMuon"
Stream="SingleElectron" ### DoubleMuon DoubleEG MuonEG SingleElectron SingleMuon 
