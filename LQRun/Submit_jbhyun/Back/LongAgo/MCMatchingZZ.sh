...
## RUN PARAMETERS
job_cycle="Jun2016_3l4j_MCmatchingStudy_ZZ" ###"ExampleAnalyzerDiMuon"
...
###    declare -a input_samples=("DY10to50" "DY50plus" "WJets" "TTJets_MG5" "WZ" "ZZ" "WW" "singletop_tbar" "singletop_t" "singletop_tbarW" "singletop_tW" "ttWJetsToLNu" "ttWJetsToQQ" "ttZToLLNuNu" "ttZToQQ" "ZZ_pythia8")
###    declare -a input_samples=("WZ")
    declare -a input_samples=("ZZ_pythia8")
###"ZZ_pythia8""ZZ_llqq_MCatNLO"
    source submit.sh $1
fi
