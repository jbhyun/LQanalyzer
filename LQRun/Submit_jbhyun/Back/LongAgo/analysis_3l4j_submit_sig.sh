...
## RUN PARAMETERS
job_cycle="Aug2016_3l4j_SigBkgBasic" ###"Jun2016_3l4j_SigBasic" ###KPS ###"ExampleAnalyzerDiMuon"
job_data_lumi="ALL"   ###  "C" = period C only   "ALL" or "CtoD"  = period C+D
job_stream="MuonEG" ###"SingleElectron" ### DoubleMuon DoubleEG MuonEG SingleElectron SingleMuon 
job_skinput="True" 
