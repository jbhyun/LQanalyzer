...
AnalysisCode="Mar2019_AdditionalChecks" 
...
RunningMode="TriMu,FkSrcCheck"
#"EMuMu,SigEffValid" "TriMu,SigEffValid "EMuMu,JetVetoCheck" "TriMu,JetVetoCheck"
#"EMuMu,FkSrcCheck" "TriMu,FkSrcCheck"

#MCList="Signal_All"   #"Signal_All" "SigEffValidCheck"
MCList="TT_All"
#MCList="UnRun"
...
elif [[ ${DataPeriod} == "C" ]]; then dir_period="periodC";elif [[ ${DataPeriod} == "D" ]]; then dir_period="periodD";
