...
export IDFILEDIR=${LQANALYZER_DIR}/data/ID/76X/
export LUMIFILEDIR=${LQANALYZER_DIR}/data/Luminosity/76X/
export TRIGGERFILEDIR=${LQANALYZER_DIR}/data/Trigger/76X/
export BTAGFILEDIR=${LQANALYZER_DIR}/data/BTag/76X/
export PILEUPFILEDIR=${LQANALYZER_DIR}/data/Pileup/76X/
