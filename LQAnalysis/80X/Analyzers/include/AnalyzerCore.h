...
class AnalyzerCore : public LQCycleBase {
 ...
 public:
  ...
  float MC_CR_Correction(TString analysis, int syst=0);
  ...
  std::vector<snu::KJet> GetJetsAwayFromFatJet(TString jetid,std::vector<snu::KFatJet> fjets, std::vector<snu::KMuon> muons, std::vector<snu::KElectron> el, TString Option,float ptcut, float etacut);

  std::vector<snu::KJet>  GetJets(TString jetid, TString Option="", float ptcut=-999., float etacut = -999.);
  std::vector<snu::KJet>  GetJets(TString jetid, std::vector<snu::KMuon> muons, std::vector<snu::KElectron> el, TString Option="", float ptcut=-999., float etacut = -999.);
  std::vector<snu::KFatJet>  GetFatJets(TString jetid, TString Option="", float ptcut=-999., float etacut = -999.);
  std::vector<snu::KFatJet>  GetFatJets(TString jetid, std::vector<snu::KMuon> muons, std::vector<snu::KElectron> el,  TString Option="", float ptcut=-999., float etacut = -999.);
  std::vector<snu::KMuon> GetMuons(TString muid, TString Option="",float ptcut=-999., float etacut = -999.);
