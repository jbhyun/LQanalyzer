#ifndef Oct2017_MuFRSyst_h
#define Oct2017_MuFRSyst_h

#include "AnalyzerCore.h"


class Oct2017_MuFRSyst : public AnalyzerCore {
 ...
 public:
  ...
  void CheckPromptVariation(std::vector<snu::KMuon> MuTColl, std::vector<snu::KMuon> MuLColl, std::vector<snu::KElectron> EleLColl, std::vector<snu::KJet> JetColl, std::vector<snu::KJet> BJetColl, float MET, float METx, float METy, float weight, TString Label, TString Option);
  void CheckMuFRSyst(std::vector<snu::KMuon> MuPreColl, std::vector<snu::KElectron> EleLColl, std::vector<snu::KJet> JetNoVetoColl, std::vector<snu::KJet> BJetNoVetoColl, float MET, float METx, float METy, float weight, TString LooseID, TString TightID, TString Label, TString Option);
 private:
