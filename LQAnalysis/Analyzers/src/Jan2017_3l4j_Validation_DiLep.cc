// $Id: Jan2017_3l4j_Validation_DiLep.cc 1 2013-11-26 10:23:10Z jalmond $
/***************************************************************************
 * @Project: LQJan2017_3l4j_Validation_DiLep Frame - ROOT-based analysis framework for Korea SNU
 * @Package: LQCycles
 *
...
/// Local includes
 #include "Jan2017_3l4j_Validation_DiLep.h"
 ...
 ClassImp (Jan2017_3l4j_Validation_DiLep);

 Jan2017_3l4j_Validation_DiLep::Jan2017_3l4j_Validation_DiLep() : AnalyzerCore(), out_muons(0) {

   SetLogName("Jan2017_3l4j_Validation_DiLep");
   Message("In Jan2017_3l4j_Validation_DiLep constructor", INFO);
   InitialiseAnalysis();
 }


 void Jan2017_3l4j_Validation_DiLep::InitialiseAnalysis() throw( LQError ) {
...
void Jan2017_3l4j_Validation_DiLep::ExecuteEvents()throw( LQError ){
...
void Jan2017_3l4j_Validation_DiLep::EndCycle()throw( LQError ){
...
void Jan2017_3l4j_Validation_DiLep::BeginCycle() throw( LQError ){
...
Jan2017_3l4j_Validation_DiLep::~Jan2017_3l4j_Validation_DiLep() {
  
  Message("In Jan2017_3l4j_Validation_DiLep Destructor" , INFO);
//  if(!k_isdata)delete reweightPU;
  
}

void Jan2017_3l4j_Validation_DiLep::FillCutFlow(TString cut, float weight){
...
void Jan2017_3l4j_Validation_DiLep::BeginEvent( )throw( LQError ){
...
void Jan2017_3l4j_Validation_DiLep::MakeHistograms(){
...
*/
  ...
  // **
  // *  Remove//Overide this Jan2017_3l4j_Validation_DiLepCore::MakeHistograms() to make new hists for your analysis
  // **
...
void Jan2017_3l4j_Validation_DiLep::ClearOutputVectors() throw(LQError) {
