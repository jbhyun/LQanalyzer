...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   ***************************************************************************************/
   ...
   std::vector<snu::KElectron> electronPreColl; eventbase->GetElectronSel()->Selection(electronPreColl);
     ...
     else if(TriMu) { if( !(electronPreColl.size()>=2) ) return; }
...
float Aug2017_TriLepSR::FakeRateData(snu::KElectron Ele, TString ID){
...
float Aug2017_TriLepSR::GetFakeWeight(std::vector<snu::KMuon> MuLColl, std::vector<snu::KElectron> EleLColl, TString MuLID, TString MuTID, TString EleLID, TString EleTID){
