// $Id: Jan2017_3l4j_ttZComposition.cc 1 2013-11-26 10:23:10Z jalmond $
/***************************************************************************
 * @Project: LQJan2017_3l4j_ttZComposition Frame - ROOT-based analysis framework for Korea SNU
 * @Package: LQCycles
 *
...
/// Local includes
 #include "Jan2017_3l4j_ttZComposition.h"
 ...
 ClassImp (Jan2017_3l4j_ttZComposition);

 Jan2017_3l4j_ttZComposition::Jan2017_3l4j_ttZComposition() : AnalyzerCore(), out_muons(0) {

   SetLogName("Jan2017_3l4j_ttZComposition");
   Message("In Jan2017_3l4j_ttZComposition constructor", INFO);
   InitialiseAnalysis();
 }


 void Jan2017_3l4j_ttZComposition::InitialiseAnalysis() throw( LQError ) {
...
void Jan2017_3l4j_ttZComposition::ExecuteEvents()throw( LQError ){
...
void Jan2017_3l4j_ttZComposition::EndCycle()throw( LQError ){
...
void Jan2017_3l4j_ttZComposition::BeginCycle() throw( LQError ){
...
Jan2017_3l4j_ttZComposition::~Jan2017_3l4j_ttZComposition() {
  
  Message("In Jan2017_3l4j_ttZComposition Destructor" , INFO);
//  if(!k_isdata)delete reweightPU;
  
}

void Jan2017_3l4j_ttZComposition::FillCutFlow(TString cut, float weight){
...
void Jan2017_3l4j_ttZComposition::BeginEvent( )throw( LQError ){
...
void Jan2017_3l4j_ttZComposition::MakeHistograms(){
...
*/
  ...
  // **
  // *  Remove//Overide this Jan2017_3l4j_ttZCompositionCore::MakeHistograms() to make new hists for your analysis
  // **
...
void Jan2017_3l4j_ttZComposition::ClearOutputVectors() throw(LQError) {
