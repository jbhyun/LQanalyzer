// $Id: Mar2017_TriLepComp_3lb.cc 1 2013-11-26 10:23:10Z jalmond $
/***************************************************************************
 * @Project: LQMar2017_TriLepComp_3lb Frame - ROOT-based analysis framework for Korea SNU
 * @Package: LQCycles
 *
...
/// Local includes
 #include "Mar2017_TriLepComp_3lb.h"
 ...
 ClassImp (Mar2017_TriLepComp_3lb);

 Mar2017_TriLepComp_3lb::Mar2017_TriLepComp_3lb() : AnalyzerCore(), out_muons(0) {

   SetLogName("Mar2017_TriLepComp_3lb");
   Message("In Mar2017_TriLepComp_3lb constructor", INFO);
   InitialiseAnalysis();
 }


 void Mar2017_TriLepComp_3lb::InitialiseAnalysis() throw( LQError ) {
...
void Mar2017_TriLepComp_3lb::ExecuteEvents()throw( LQError ){
...
/************************************************************************************/
   ...
   if(TriMu_analysis){
     ...
     FillHist("Nb_3lM41b2jCut_3mu", nbjets, weight, 0., 10., 10);
     FillHist("Nlj_3lM41b2jCut_3mu", nljets, weight, 0., 10., 10);
     FillHist("Nj_3lM41b2jCut_3mu", njets, weight, 0., 10., 10);
     FillHist("MET_3lM41b2jCut_3mu", met, weight, 0., 200., 200);
     FillHist("MTW_3lM41b2jCut_3mu", MTW, weight, 0., 300., 300); 
     FillHist("Mmumu_OSSS1_3lM41b2jCut_3mu", Mmumu_OSSS1, weight, 0., 200., 200);
     FillHist("Mmumu_OSSS2_3lM41b2jCut_3mu", Mmumu_OSSS2, weight, 0., 200., 200);
     FillHist("Mmumu_Zcand_3lM41b2jCut_3mu", (muonColl.at(IdxZCandLead_NoLim)+muonColl.at(IdxZCandSubl_NoLim)).M(), weight, 0., 200., 200);
     FillHist("PTmu1_3lM41b2jCut_3mu", muonColl.at(0).Pt(), weight, 0., 200., 200);
     FillHist("PTmu2_3lM41b2jCut_3mu", muonColl.at(1).Pt(), weight, 0., 200., 200);
     FillHist("PTmu3_3lM41b2jCut_3mu", muonColl.at(2).Pt(), weight, 0., 200., 200);
     FillHist("Etamu1_3lM41b2jCut_3mu", muonColl.at(0).Eta(), weight, -5., 5., 100);
     FillHist("Etamu2_3lM41b2jCut_3mu", muonColl.at(1).Eta(), weight, -5., 5., 100);
     FillHist("Etamu3_3lM41b2jCut_3mu", muonColl.at(2).Eta(), weight, -5., 5., 100);

     if(IdxZCandLead!=-1 && IdxZCandSubl!=-1){
       FillHist("Mmumu_ttZ_3lM41b2jCut_3mu", (muonColl.at(IdxZCandLead)+muonColl.at(IdxZCandSubl)).M(), weight, 0., 200., 200);
     }
     ...
     if(IdxZCandLead!=-1 && IdxZCandSubl!=-1){
       ...
       FillHist("PTmu1_ttZ_3lM41b3jCut_3mu", muonColl.at(0).Pt(), weight, 0., 300., 300);
       FillHist("PTmu2_ttZ_3lM41b3jCut_3mu", muonColl.at(1).Pt(), weight, 0., 200., 200);
       FillHist("PTmu3_ttZ_3lM41b3jCut_3mu", muonColl.at(2).Pt(), weight, 0., 200., 200);
       FillHist("PTmuW_ttZ_3lM41b3jCut_3mu", muonColl.at(IdxWCand).Pt(), weight, 0., 200., 200);
       FillHist("Etamu1_ttZ_3lM41b3jCut_3mu", muonColl.at(0).Eta(), weight, -2.5, 2.5, 100);
       FillHist("Etamu2_ttZ_3lM41b3jCut_3mu", muonColl.at(1).Eta(), weight, -2.5, 2.5, 100);
       FillHist("Etamu3_ttZ_3lM41b3jCut_3mu", muonColl.at(2).Eta(), weight, -2.5, 2.5, 100);
       FillHist("EtamuW_ttZ_3lM41b3jCut_3mu", muonColl.at(IdxWCand).Eta(), weight, -2.5, 2.5, 100);
     }
     ...
     FillHist("Mmumu_OSSS1_3lM41b3jCut_3mu", Mmumu_OSSS1, weight, 0., 200., 200);
     FillHist("Mmumu_OSSS2_3lM41b3jCut_3mu", Mmumu_OSSS2, weight, 0., 200., 200);
     ...
     FillHist("PTb1_3lM41b3jCut_3mu", bjetColl.at(0).Pt(), weight, 0., 300., 300);
     ...
     FillHist("PTb1_3lM41b3jMZCut_3mu", bjetColl.at(0).Pt(), weight, 0., 300., 300);
...
void Mar2017_TriLepComp_3lb::EndCycle()throw( LQError ){
...
void Mar2017_TriLepComp_3lb::BeginCycle() throw( LQError ){
...
Mar2017_TriLepComp_3lb::~Mar2017_TriLepComp_3lb() {
  
  Message("In Mar2017_TriLepComp_3lb Destructor" , INFO);
//  if(!k_isdata)delete reweightPU;
  
}

void Mar2017_TriLepComp_3lb::FillCutFlow(TString cut, float weight){
  ...
  if(GetHist("cutflow_W") && GetHist("cutflow_N")){
    ...
    if(!GetHist("cutflow_W")){
      ...
      GetHist("cutflow_W")->GetXaxis()->SetBinLabel(9,"M(#mu#mu)>40");
      GetHist("cutflow_W")->GetXaxis()->SetBinLabel(10,"3j");
      GetHist("cutflow_W")->GetXaxis()->SetBinLabel(11,"ZVeto");
      GetHist("cutflow_W")->GetXaxis()->SetBinLabel(12,"Nlj2");
    }
    if(!GetHist("cutflow_N")){
      ...
      GetHist("cutflow_N")->GetXaxis()->SetBinLabel(9,"M(#mu#mu)>40");
      GetHist("cutflow_N")->GetXaxis()->SetBinLabel(10,"3j");
      GetHist("cutflow_N")->GetXaxis()->SetBinLabel(11,"ZVeto");
      GetHist("cutflow_N")->GetXaxis()->SetBinLabel(12,"Nlj2");
    }
  }
}
...
void Mar2017_TriLepComp_3lb::BeginEvent( )throw( LQError ){
...
void Mar2017_TriLepComp_3lb::MakeHistograms(){
  ...
  // **
  // *  Remove//Overide this Mar2017_TriLepComp_3lbCore::MakeHistograms() to make new hists for your analysis
  // **
...
void Mar2017_TriLepComp_3lb::ClearOutputVectors() throw(LQError) {
