// $Id: Aug2017_ObjEffCalc.cc 1 2013-11-26 10:23:10Z jalmond $
/***************************************************************************
 * @Project: LQAug2017_ObjEffCalc Frame - ROOT-based analysis framework for Korea SNU
 * @Package: LQCycles
 *
...
/// Local includes
 ...
 ClassImp (Aug2017_ObjEffCalc);

 Aug2017_ObjEffCalc::Aug2017_ObjEffCalc() : AnalyzerCore(), out_muons(0) {

   SetLogName("Aug2017_ObjEffCalc");
   Message("In Aug2017_ObjEffCalc constructor", INFO);
   InitialiseAnalysis();
 }


 void Aug2017_ObjEffCalc::InitialiseAnalysis() throw( LQError ) {
...
void Aug2017_ObjEffCalc::ExecuteEvents()throw( LQError ){
...
///////////////////////////////////////////////////////////////////////////////
   ...
   //Electron ID's to Test
     ...
     eventbase->GetElectronSel()->SetPt(25.);                eventbase->GetElectronSel()->SetEta(2.5);
     eventbase->GetElectronSel()->SetBETrRegIncl(false);
     eventbase->GetElectronSel()->SetRelIsoType("Default");  eventbase->GetElectronSel()->SetRelIsoBEMax(0.0994, 0.107);
     eventbase->GetElectronSel()->SetdxyBEMax(0.05, 0.1);    eventbase->GetElectronSel()->SetdzBEMax(0.1, 0.2);
   std::vector<snu::KElectron> electronCBPOGMColl; eventbase->GetElectronSel()->Selection(electronCBPOGMColl);
     ...
     eventbase->GetElectronSel()->SetdxyBEMax(0.05, 0.1);    eventbase->GetElectronSel()->SetdzBEMax(0.1, 0.2);
   std::vector<snu::KElectron> electronCBPOGTColl; eventbase->GetElectronSel()->Selection(electronCBPOGTColl);
   ...
   std::vector<snu::KElectron> electronMVAPOGMIsop1Coll; eventbase->GetElectronSel()->Selection(electronMVAPOGMIsop1Coll);
     ...
     eventbase->GetElectronSel()->SetdxySigMax(4.);
     eventbase->GetElectronSel()->SetApplyConvVeto(true);
   std::vector<snu::KElectron> electronMVAPOGMIsop08Coll; eventbase->GetElectronSel()->Selection(electronMVAPOGMIsop08Coll);
     ...
     eventbase->GetElectronSel()->SetdxySigMax(4.);
     eventbase->GetElectronSel()->SetApplyConvVeto(true);
   std::vector<snu::KElectron> electronMVAPOGMIsop06Coll; eventbase->GetElectronSel()->Selection(electronMVAPOGMIsop06Coll);
     ...
     eventbase->GetElectronSel()->SetdxySigMax(4.);
     eventbase->GetElectronSel()->SetApplyConvVeto(true);
   std::vector<snu::KElectron> electronMVAPOGTIsop1Coll; eventbase->GetElectronSel()->Selection(electronMVAPOGTIsop1Coll);
     ...
     eventbase->GetElectronSel()->SetdxySigMax(4.);
     eventbase->GetElectronSel()->SetApplyConvVeto(true);
   std::vector<snu::KElectron> electronMVAPOGTIsop08Coll; eventbase->GetElectronSel()->Selection(electronMVAPOGTIsop08Coll);
     ...
     eventbase->GetElectronSel()->SetdxySigMax(4.);
     eventbase->GetElectronSel()->SetApplyConvVeto(true);
   std::vector<snu::KElectron> electronMVAPOGTIsop06Coll; eventbase->GetElectronSel()->Selection(electronMVAPOGTIsop06Coll);
...
/************************************************************************************/
   ...
   if(EleEff){
     ...
     //N_IDpass - Numerator, 
     int Nprompt_CBPOGM        = NPromptFake_Ele(electronCBPOGMColl       ,truthColl,"Prompt");
     int Nprompt_CBPOGT        = NPromptFake_Ele(electronCBPOGTColl       ,truthColl,"Prompt");
     int Nprompt_MVAPOGMIsop1  = NPromptFake_Ele(electronMVAPOGMIsop1Coll ,truthColl,"Prompt");
     int Nprompt_MVAPOGMIsop08 = NPromptFake_Ele(electronMVAPOGMIsop08Coll,truthColl,"Prompt");
     int Nprompt_MVAPOGMIsop06 = NPromptFake_Ele(electronMVAPOGMIsop06Coll,truthColl,"Prompt");
     int Nprompt_MVAPOGTIsop1  = NPromptFake_Ele(electronMVAPOGTIsop1Coll ,truthColl,"Prompt");
     int Nprompt_MVAPOGTIsop08 = NPromptFake_Ele(electronMVAPOGTIsop08Coll,truthColl,"Prompt");
     int Nprompt_MVAPOGTIsop06 = NPromptFake_Ele(electronMVAPOGTIsop06Coll,truthColl,"Prompt");

     int Nfake_CBPOGM        = NPromptFake_Ele(electronCBPOGMColl       ,truthColl,"Fake");
     int Nfake_CBPOGT        = NPromptFake_Ele(electronCBPOGTColl       ,truthColl,"Fake");
     int Nfake_MVAPOGMIsop1  = NPromptFake_Ele(electronMVAPOGMIsop1Coll ,truthColl,"Fake");
     int Nfake_MVAPOGMIsop08 = NPromptFake_Ele(electronMVAPOGMIsop08Coll,truthColl,"Fake");
     int Nfake_MVAPOGMIsop06 = NPromptFake_Ele(electronMVAPOGMIsop06Coll,truthColl,"Fake");
     int Nfake_MVAPOGTIsop1  = NPromptFake_Ele(electronMVAPOGTIsop1Coll ,truthColl,"Fake");
     int Nfake_MVAPOGTIsop08 = NPromptFake_Ele(electronMVAPOGTIsop08Coll,truthColl,"Fake");
     int Nfake_MVAPOGTIsop06 = NPromptFake_Ele(electronMVAPOGTIsop06Coll,truthColl,"Fake");


     FillHist("IDeff_NEleIDp", 0., Nprompt_CBPOGM       *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDp", 1., Nprompt_CBPOGT       *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDp", 2., Nprompt_MVAPOGMIsop1 *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDp", 3., Nprompt_MVAPOGMIsop08*weight, 0., 10., 10);
     FillHist("IDeff_NEleIDp", 4., Nprompt_MVAPOGMIsop06*weight, 0., 10., 10);
     FillHist("IDeff_NEleIDp", 5., Nprompt_MVAPOGTIsop1 *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDp", 6., Nprompt_MVAPOGTIsop08*weight, 0., 10., 10);
     FillHist("IDeff_NEleIDp", 7., Nprompt_MVAPOGTIsop06*weight, 0., 10., 10);

     FillHist("IDeff_NEleIDf", 0., Nfake_CBPOGM       *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDf", 1., Nfake_CBPOGT       *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDf", 2., Nfake_MVAPOGMIsop1 *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDf", 3., Nfake_MVAPOGMIsop08*weight, 0., 10., 10);
     FillHist("IDeff_NEleIDf", 4., Nfake_MVAPOGMIsop06*weight, 0., 10., 10);
     FillHist("IDeff_NEleIDf", 5., Nfake_MVAPOGTIsop1 *weight, 0., 10., 10);
     FillHist("IDeff_NEleIDf", 6., Nfake_MVAPOGTIsop08*weight, 0., 10., 10);
     FillHist("IDeff_NEleIDf", 7., Nfake_MVAPOGTIsop06*weight, 0., 10., 10);
...
void Aug2017_ObjEffCalc::EndCycle()throw( LQError ){
...
void Aug2017_ObjEffCalc::BeginCycle() throw( LQError ){
...
Aug2017_ObjEffCalc::~Aug2017_ObjEffCalc() {
  
  Message("In Aug2017_ObjEffCalc Destructor" , INFO);
//  if(!k_isdata)delete reweightPU;
  
}

int Aug2017_ObjEffCalc::NPromptFake_Ele(std::vector<snu::KElectron> EleColl, TString Option){
...
int Aug2017_ObjEffCalc::NPromptFake_Mu(std::vector<snu::KMuon> MuColl, TString Option){
...
int Aug2017_ObjEffCalc::NPromptFake_Mu(std::vector<snu::KMuon> MuColl, std::vector<snu::KTruth> truthColl, TString Option){
...
int Aug2017_ObjEffCalc::NPromptFake_Ele(std::vector<snu::KElectron> EleColl, std::vector<snu::KTruth> truthColl, TString Option){
...
bool Aug2017_ObjEffCalc::IsConvCand(snu::KElectron Ele, std::vector<snu::KTruth> TruthColl, TString Option){
...
void Aug2017_ObjEffCalc::FillCutFlow(TString cut, float weight){
...
void Aug2017_ObjEffCalc::BeginEvent( )throw( LQError ){
...
void Aug2017_ObjEffCalc::MakeHistograms(){
  ...
  // **
  // *  Remove//Overide this Aug2017_ObjEffCalcCore::MakeHistograms() to make new hists for your analysis
  // **
...
void Aug2017_ObjEffCalc::ClearOutputVectors() throw(LQError) {
