// $Id: Sep2016_3l4j_Validation_DiLep.cc 1 2013-11-26 10:23:10Z jalmond $
/***************************************************************************
 * @Project: LQSep2016_3l4j_Validation_DiLep Frame - ROOT-based analysis framework for Korea SNU
 * @Package: LQCycles
 *
...
/// Local includes
 #include "Sep2016_3l4j_Validation_DiLep.h"
 ...
 ClassImp (Sep2016_3l4j_Validation_DiLep);

 Sep2016_3l4j_Validation_DiLep::Sep2016_3l4j_Validation_DiLep() : AnalyzerCore(), out_muons(0) {

   SetLogName("Sep2016_3l4j_Validation_DiLep");
   Message("In Sep2016_3l4j_Validation_DiLep constructor", INFO);
   InitialiseAnalysis();
 }


 void Sep2016_3l4j_Validation_DiLep::InitialiseAnalysis() throw( LQError ) {
...
void Sep2016_3l4j_Validation_DiLep::ExecuteEvents()throw( LQError ){
...
void Sep2016_3l4j_Validation_DiLep::EndCycle()throw( LQError ){
...
void Sep2016_3l4j_Validation_DiLep::BeginCycle() throw( LQError ){
...
Sep2016_3l4j_Validation_DiLep::~Sep2016_3l4j_Validation_DiLep() {
  
  Message("In Sep2016_3l4j_Validation_DiLep Destructor" , INFO);
//  if(!k_isdata)delete reweightPU;
  
}

void Sep2016_3l4j_Validation_DiLep::FillCutFlow(TString cut, float weight){
...
void Sep2016_3l4j_Validation_DiLep::BeginEvent( )throw( LQError ){
...
void Sep2016_3l4j_Validation_DiLep::MakeHistograms(){
...
*/
  ...
  // **
  // *  Remove//Overide this Sep2016_3l4j_Validation_DiLepCore::MakeHistograms() to make new hists for your analysis
  // **
...
void Sep2016_3l4j_Validation_DiLep::ClearOutputVectors() throw(LQError) {
