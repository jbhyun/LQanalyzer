...
//   if(muonColl.size()>1){ if(muonColl.at(1).Pt()<20) return;}
...
//   FillCutFlow("TriggerCut", weight); //;in trigger Cut mode
   /////////////////////////////////////////////////////////////////////////////////////////
   if (trimu_analysis) trigger_eff = TriggerEff(analysis_trigger, muonColl);
...
//                        v[1].SetPx(met_x); v[1].SetPy(met_y);
   ...
   //Scale Factors
   float id_weight=1., reco_weight=1., iso_weight=1., trk_weight=1.;
   if(!isData){
     id_weight  *= MuonScaleFactor("MUON_POG_TIGHT", muonColl,0);
     iso_weight *= MuonISOScaleFactor("MUON_POG_TIGHT", muonColl,0);
     trk_weight *= MuonTrackingEffScaleFactor(muonColl);
...
///////////////////////////////////////////////////////////////////////////////////   
   if(trimu_analysis){
     ...
     if(PassTrigger("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v")){
       ...
       //MuIDSF
       FillHist("Mmumu_Trig1_IDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*id_weight, 0., 200., 200);
  
       //MuIsoSF
       FillHist("Mmumu_Trig1_IsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*iso_weight, 0., 200., 200);
       ...
       //Combination
       //TrkSF
       FillHist("Mmumu_Trig1_TrkSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight, 0., 200., 200);
  
       //MuIDSF
       FillHist("Mmumu_Trig1_TrkIDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight, 0., 200., 200);
  
       //MuIsoSF
       FillHist("Mmumu_Trig1_TrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight, 0., 200., 200);
  
       //PUrw
       FillHist("Mmumu_Trig1_PUTrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight*pileup_reweight, 0., 200., 200);

       //DYCounter
       if(fabs((muonColl.at(0)+muonColl.at(1)).M()-91.2)<15){
         FillHist("DYCounter_NoW", 0., weight, 0., 3., 3);
         FillHist("DYCounter_PUTrkIDIsoSF", 0., weight*trk_weight*id_weight*iso_weight*pileup_reweight, 0., 3., 3);
       }
     }
     if(PassTrigger("HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v")){
       ...
       //MuIDSF
       FillHist("Mmumu_Trig2_IDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*id_weight, 0., 200., 200);
  
       //MuIsoSF
       FillHist("Mmumu_Trig2_IsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*iso_weight, 0., 200., 200);
       ...
       //Combination
       //TrkSF
       FillHist("Mmumu_Trig2_TrkSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight, 0., 200., 200);
  
       //MuIDSF
       FillHist("Mmumu_Trig2_TrkIDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight, 0., 200., 200);
  
       //MuIsoSF
       FillHist("Mmumu_Trig2_TrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight, 0., 200., 200);
  
       //PUrw
       FillHist("Mmumu_Trig2_PUTrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight*pileup_reweight, 0., 200., 200);

       //DYCounter
       if(fabs((muonColl.at(0)+muonColl.at(1)).M()-91.2)<15){
         FillHist("DYCounter_NoW", 1., weight, 0., 3., 3);
         FillHist("DYCounter_PUTrkIDIsoSF", 1., weight*trk_weight*id_weight*iso_weight*pileup_reweight, 0., 3., 3);
       }
     ...
     if(PassTrigger("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v") || PassTrigger("HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v")){
       ...
       if(fabs((muonColl.at(0)+muonColl.at(1)).M()-91.2)<15){
         ...
         FillHist("DYCounter_PUTrkIDIsoSF", 2., weight*trk_weight*id_weight*iso_weight*pileup_reweight, 0., 3., 3);
       }
     }
     if(isData){
       if(PassTrigger("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v")){
         ...
         //MuIDSF
         FillHist("Mmumu_Trig1W_IDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*id_weight, 0., 200., 200);
    
         //MuIsoSF
         FillHist("Mmumu_Trig1W_IsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*iso_weight, 0., 200., 200);
         ...
         //Combination
         //TrkSF
         FillHist("Mmumu_Trig1W_TrkSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight, 0., 200., 200);
    
         //MuIDSF
         FillHist("Mmumu_Trig1W_TrkIDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight, 0., 200., 200);
    
         //MuIsoSF
         FillHist("Mmumu_Trig1W_TrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight, 0., 200., 200);
    
         //PUrw
         FillHist("Mmumu_Trig1W_PUTrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight*pileup_reweight, 0., 200., 200);
       }
       if(PassTrigger("HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v")){
         if(muonColl.size()!=2) return;
         if(SumCharge(muonColl)!=0) return;
         ...
         //MuIDSF
         FillHist("Mmumu_Trig2W_IDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*id_weight, 0., 200., 200);
    
         //MuIsoSF
         FillHist("Mmumu_Trig2W_IsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*iso_weight, 0., 200., 200);
         ...
         //Combination
         //TrkSF
         FillHist("Mmumu_Trig2W_TrkSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight, 0., 200., 200);
    
         //MuIDSF
         FillHist("Mmumu_Trig2W_TrkIDSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight, 0., 200., 200);
    
         //MuIsoSF
         FillHist("Mmumu_Trig2W_TrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight, 0., 200., 200);
    
         //PUrw
         FillHist("Mmumu_Trig2W_PUTrkIDIsoSF", (muonColl.at(0)+muonColl.at(1)).M(), weight*trk_weight*id_weight*iso_weight*pileup_reweight, 0., 200., 200);
       }
     }
     else{
         if(muonColl.size()!=2) return;
