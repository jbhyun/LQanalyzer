...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  /// Apply the gen weight 
   ...
   if (!k_isdata) { pileup_reweight = pileup_reweight=eventbase->GetEvent().PileUpWeight(); }
...
//   bool EMu_analysis=true, DoubleMu_analysis=false;
   bool DoubleEle_analysis=true, DoubleMu_analysis=false, EMu_analysis=false;
...
//                        v[1].SetPx(met_x); v[1].SetPy(met_y);
   ...
   //Scale Factors
   float id_weight_mu=1., reco_weight=1., iso_weight_mu=1., trk_weight_mu=1., id_weight_ele=1.;
   if(!isData){
...
//     weight*=id_weight_mu*reco_weight*iso_weight_mu;
   }
