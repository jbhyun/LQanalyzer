...
// $Id: SKTreeMakerDiLep_Trig.cc 1 2013-11-26 10:23:10Z jalmond $
/***************************************************************************
...
/// Local includes
#include "SKTreeMakerDiLep_Trig.h"
...
ClassImp (SKTreeMakerDiLep_Trig);
 ...
 *
 */
SKTreeMakerDiLep_Trig::SKTreeMakerDiLep_Trig() :  AnalyzerCore(), out_muons(0), out_electrons(0),out_photons(0), out_jets(0), out_fatjets(0),out_genjets(0), out_truth(0), nevents(0),pass_eventcut(0), pass_vertexcut(0) {

  // To have the correct name in the log:                                                                                                                            
  SetLogName("SKTreeMakerDiLep_Trig");
...
void SKTreeMakerDiLep_Trig::ExecuteEvents()throw( LQError ){
...
void SKTreeMakerDiLep_Trig::EndCycle()throw( LQError ){
  
  Message("In EndCycle" , INFO);
}


void SKTreeMakerDiLep_Trig::BeginCycle() throw( LQError ){
...
SKTreeMakerDiLep_Trig::~SKTreeMakerDiLep_Trig() {
...
void SKTreeMakerDiLep_Trig::FillCutFlow(TString cut, float weight){
...
void SKTreeMakerDiLep_Trig::BeginEvent( )throw( LQError ){
...
void SKTreeMakerDiLep_Trig::ClearOutputVectors() throw (LQError){
  //
